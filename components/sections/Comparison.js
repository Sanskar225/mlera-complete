      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-14">
          ...
          <AnimatedSection delay={200}>
            <p className="text-[var(--muted)] font-dm text-lg max-w-sm mx-auto">Side-by-side, no fluff.</p>
          </AnimatedSection>
        </div>
        ...
        <AnimatedSection delay={150}>
          <div className="rounded-2xl overflow-hidden border border-[var(--border)] shadow-card">
            ...
            <div className="grid grid-cols-3 bg-[var(--surface-2)]">
              ...
              <div className="px-6 py-5 text-center border-x border-[var(--border)]">
                <span className="font-syne font-extrabold text-base gradient-text">MLera</span>
              </div>
              <div className="px-6 py-5 text-center">
                <span className="font-syne font-bold text-[var(--muted)] text-sm">Other Platforms</span>
              </div>
            </div>
