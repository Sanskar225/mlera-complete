...
// Replace this function body to connect to your real API / Resend / Supabase / Mailchimp
...
export default function CTA() {
  ...
  return (
    <section id="join" className="section-padding relative overflow-hidden">
      ...
      <div aria-hidden className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[900px] h-[900px] rounded-full border border-[rgba(139,92,246,0.04)] animate-rotate-slow pointer-events-none" />

      <div className="relative z-10 max-w-2xl mx-auto text-center">
        <AnimatedSection>
          <div className="flex justify-center mb-6">
            <NeuralIcon size={48} className="animate-float" />
          </div>
        </AnimatedSection>
