...
function Counter({ target, suffix, color, isVisible }) {
  ...
  return (
    <span
      className="font-syne font-extrabold text-5xl md:text-6xl tabular-nums"
      style={{ background: `linear-gradient(135deg, ${color}, ${color}80)`, WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}
    >
      {count}{suffix}
    </span>
  );
