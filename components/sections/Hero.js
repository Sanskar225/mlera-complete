...
export default function Hero() {
  ...
  return (
    <section
      id="hero"
      className="relative min-h-screen flex items-center px-[5%] pt-20 pb-16 overflow-hidden"
    >
      {/* Background Grid */}
      <div className="absolute inset-0 grid-bg" />

      {/* Glow Orbs - repositioned for better balance */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full">
        ...
        {/* TOP SECTION - Hero text centered with better spacing */}
        <div className="text-center max-w-4xl mx-auto mb-16 lg:mb-20">
          ...
          <div className="animate-fade-up inline-flex items-center gap-2 bg-violet/10 border border-violet/25 rounded-full px-4 py-1.5 mb-5">
            ...
            <span className="text-lavender text-xs font-syne font-semibold tracking-[0.1em] uppercase">
              Built at IIIT Dharwad Research Park
            </span>
          </div>

          {/* Headline - reduced size slightly for better hierarchy */}
          ...
          <p className="animate-fade-up text-[var(--muted)] text-base md:text-lg font-dm leading-relaxed max-w-2xl mx-auto">
            ...
            <strong className="text-[var(--text-dim)] font-medium">
              structured paths, concept clarity,
            </strong>{" "}
            and a{" "}
            <strong className="text-[var(--text-dim)] font-medium">
              built-in lexicon
        ...
        {/* STATS CARD - Centered below headline */}
        ...
        {/* BOTTOM SECTION - Three column layout for CTA + Features + Video */}
        <div className="grid lg:grid-cols-12 gap-6 items-start">
          
          {/* CTA Buttons - Left column (3 cols) */}
          <div className="lg:col-span-3 animate-fade-up">
            <div className="bg-[var(--surface)]/30 backdrop-blur-md border border-[var(--border)] rounded-2xl p-5 h-full flex flex-col justify-center gap-3">
              <Button onClick={() => scrollToSection("join")} size="md" className="w-full">
                Get Early Access →
              </Button>
              <Button
                variant="outline"
              ...
              <p className="text-[0.7rem] text-[var(--muted)] text-center mt-1">
                No credit card required
              </p>
            </div>
          </div>

          {/* Features Card - Middle column (5 cols) */}
          ...
          {/* Video Card - Right column (4 cols) */}
          <div className="lg:col-span-4 animate-fade-up animate-float">
            <div className="bg-[var(--surface)]/40 backdrop-blur-md border border-[var(--border)] rounded-2xl overflow-hidden group p-4">
              {/* Video container - smaller aspect */}
