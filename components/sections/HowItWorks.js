      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-20">
          ...
          <AnimatedSection delay={200}>
            <p className="text-[var(--muted)] font-dm text-lg max-w-md mx-auto">
              Four clear stages designed to build real understanding, not just familiarity.
            </p>
          </AnimatedSection>
        </div>
        ...
        <AnimatedSection delay={200}>
          <div className="max-w-2xl mx-auto bg-[var(--surface)] border border-[var(--border)] rounded-2xl p-6 shadow-card">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="bg-emerald-500/10 border border-emerald-500/25 text-emerald-400 text-xs font-syne font-bold px-3 py-1 rounded-full tracking-wide">
                In Progress
              </span>
            </div>
