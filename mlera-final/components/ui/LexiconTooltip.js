      ...
      {open && (
        ...
        >
          <span className="block px-4 pt-4 pb-3">
            <span
              className="block text-[10px] font-syne font-bold tracking-widest uppercase mb-2"
              style={{ color: entry.color }}
            >
              {word}
            </span>
            <span
              className="block text-xs font-dm leading-relaxed mb-2.5"
              style={{ color: "var(--text-dim)" }}
            >
              {entry.simple}
            </span>
            <span
              className="block text-[11px] font-dm italic border-t border-white/5 pt-2.5"
