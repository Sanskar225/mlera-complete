        ...
        <div className="text-center mb-16">
          ...
          <AnimatedSection delay={100}>
            <h2 className="font-syne font-extrabold text-4xl md:text-5xl leading-[1.15] tracking-tight mb-5">
              ...
              <span className="gradient-text">actually learn ML</span>
            </h2>
          </AnimatedSection>
            ...
            <AnimatedSection key={f.id} delay={100 + (i % 3) * 80}>
              <div className="group h-full bg-[var(--surface)] border border-[var(--border)] rounded-2xl p-7 card-hover">
                <div className="flex items-start justify-between mb-5">
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-coral/10 to-violet/10 border border-[var(--border)] flex items-center justify-center text-2xl">
                    {f.icon}
                  </div>
                  <span className={`text-[10px] font-syne font-bold tracking-widest uppercase px-2.5 py-1 rounded-full border ${BADGE[f.badgeColor]}`}>
                    {f.badge}
                  </span>
                </div>
                <h3 className="font-syne font-bold text-[1.05rem] leading-tight mb-3 group-hover:text-white transition-colors">
                  {f.title}
                </h3>
