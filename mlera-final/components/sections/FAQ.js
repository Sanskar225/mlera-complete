      ...
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-12">
          ...
          <AnimatedSection delay={200}>
            <p className="text-[var(--muted)] font-dm text-lg">Everything you need to know before joining.</p>
          </AnimatedSection>
        </div>
        ...
        <AnimatedSection delay={300}>
          <div className="mt-10 text-center p-6 rounded-2xl border border-[var(--border)] bg-[var(--surface)]/30">
            <p className="text-[var(--muted)] font-dm text-sm">
              ...
              <a href="mailto:hello@mlera.dev" className="text-violet hover:text-lavender transition-colors font-medium underline underline-offset-4">
                Reach out to us
              </a>
